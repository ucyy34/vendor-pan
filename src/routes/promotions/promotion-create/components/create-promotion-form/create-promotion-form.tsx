...
export const CreatePromotionForm = () => {
  ...
  const form = useForm<
    z.infer<typeof CreatePromotionSchema>
  >({
    defaultValues,
  ...
  const { mutateAsync: createPromotion } =
    useCreatePromotion();
  ...
  const handleSubmit = form.handleSubmit(
    async (data) => {
      ...
      const buildRulesData = (
        ...
        return rules
          ...
          .map((rule) => ({
            operator:
              rule.operator as PromotionRuleOperatorValues,
      ...
      createPromotion(
        ...
        },
        {
          onSuccess: ({ promotion }) => {
            toast.success(
              t(
                'promotions.toasts.promotionCreateSuccess',
                {
                  code: promotion.code,
                }
              )
    ...
    async (error) => {
      ...
      const errorInPromotionTab = !!Object.keys(rest || {})
        .length;

      if (errorInPromotionTab) {
        toast.error(
          t('promotions.errors.promotionTabError')
        );
      }
    }
  );
                          ...
                          <Form.Control>
                            ...
                            >
                              <RadioGroup.ChoiceBox
                                value={'false'}
                                label={t(
                                  'promotions.form.method.code.title'
                                )}
                                description={t(
                          ...
                          <Form.Control>
                            ...
                            >
                              <RadioGroup.ChoiceBox
                                value={'draft'}
                                label={t(
                                  'promotions.form.status.draft.title'
                                )}
                                description={t(
                              ...
                              <RadioGroup.ChoiceBox
                                value={'active'}
                                label={t(
                                  'promotions.form.status.active.title'
                                )}
                                description={t(
                            ...
                            <Form.Control>
                              ...
                              >
                                ...
                                <RadioGroup.ChoiceBox
                                  value={'buyget'}
                                  label={t(
                                    'promotions.form.type.buyget.title'
                                  )}
                                  description={t(
                              ...
                              <Form.Label
                                tooltip={
                                  ...
                                  !isFixedValueType
                                    ? undefined
                                    : t(
                                        'promotions.fields.amount.tooltip'
                                      )
                                }
                              >
                                {t(
                                  'promotions.form.value.title'
                                )}
                              </Form.Label>
                          ...
                          render={({ field }) => {
                            return (
                              <Form.Item className='basis-1/2'>
                                <Form.Label>
                                  {t(
                                    'promotions.form.max_quantity.title'
                                  )}
                                </Form.Label>
