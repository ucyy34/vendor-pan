...
export const EditShippingOptionForm = ({
  ...
  const form = useForm<
    zod.infer<typeof EditShippingOptionSchema>
  >({
    defaultValues: {
      name: shippingOption.name,
      price_type:
        shippingOption.price_type as ShippingOptionPriceType,
      enabled_in_store:
        isOptionEnabledInStore(shippingOption),
      shipping_profile_id:
  ...
  const { mutateAsync, isPending: isLoading } =
    useUpdateShippingOptions(shippingOption.id);
    ...
    await mutateAsync(
      ...
      },
      {
        onSuccess: ({ shipping_option }) => {
          toast.success(
            t(
              'stockLocations.shippingOptions.edit.successToast',
              {
