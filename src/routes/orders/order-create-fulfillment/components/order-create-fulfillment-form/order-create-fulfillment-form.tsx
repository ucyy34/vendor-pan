...
export function OrderCreateFulfillmentForm({
  ...
  const {
    mutateAsync: createOrderFulfillment,
  ...
  const form = useForm<
    zod.infer<typeof CreateFulfillmentSchema>
  >({
    defaultValues: {
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    ...
    if (!selectedShippingOption) {
      form.setError('shipping_option_id', {
        type: 'manual',
        message: t(
          'orders.fulfillment.error.noShippingOption'
        ),
      });
      return;
    }
              ...
              <div className='flex flex-col divide-y divide-dashed'>
                        ...
                        <Form.Item>
                          <div className='flex flex-col gap-2 xl:flex-row xl:items-center'>
                            <div className='flex-1'>
                              ...
                              <Form.Hint>
                                {t(
                                  'orders.fulfillment.locationDescription'
                                )}
                              </Form.Hint>
                            </div>
                            <div className='flex-1'>
                        ...
                        <Form.Item>
                          <div className='flex flex-col gap-2 xl:flex-row xl:items-center'>
                            <div className='flex-1'>
                              ...
                              <Form.Hint>
                                {t(
                                  'orders.fulfillment.methodDescription'
                                )}
                              </Form.Hint>
                            </div>
                            <div className='flex-1'>
                  ...
                  {differentOptionSelected && (
                    ...
                    >
                      ...
                      <span className='text-ui-fg-muted'>
                        {t(
                          'orders.fulfillment.differentOptionSelected'
                        )}
                      </span>
                    </Alert>
                  )}
                ...
                <div>
                  <Form.Item className='mt-8'>
                    <Form.Label>
                      {t(
                        'orders.fulfillment.itemsToFulfill'
                      )}
                    </Form.Label>
                    <Form.Hint>
                      {t(
                        'orders.fulfillment.itemsToFulfillDesc'
                      )}
                    </Form.Hint>
                      ...
                      return (
                        <Form.Item>
                          <div className='flex items-center justify-between'>
                            <Form.Label>
                              {t(
                                'orders.returns.sendNotification'
                              )}
                            </Form.Label>
                            <Form.Control>
                              <Form.Control>
